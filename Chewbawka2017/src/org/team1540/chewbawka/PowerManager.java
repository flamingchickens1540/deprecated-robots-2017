...
public class PowerManager {
    ...
    public static FloatCell spikePeak = Robot.mainTuning.getFloat("[Power] Spike Peak", 50);
    public static FloatCell spikeLength = Robot.mainTuning.getFloat("[Power] Spike Length", 2);
    public static FloatCell degree = Robot.mainTuning.getFloat("[Power] Degree of Reduction", (float) 1.3);
    public static FloatCell scalingFactor = Robot.mainTuning.getFloat("[Power] Scaling Factor", 8);
    ...
    public static void setup() {
        ...
        BooleanCell enablePowerManagement = Robot.mainTuning.getBoolean("[Power] Enable Power Management", true);
