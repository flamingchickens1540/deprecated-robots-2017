...
public class Deployment {
     ...
     */
    public static final Class<? extends FRCApplication> robotMain = org.team1540.chewbawka.Robot.class;
    ...
    public static void deploy() throws Exception {
        ...
        int number = org.team1540.chewbawka.Robot.TEAM_NUMBER;
    ...
    public static void layEgg() throws Exception {
        ...
        DepEgg.layEgg(result, new ArtifactDeployer() {
            ...
            public void deployArtifact(Artifact artifact) throws Exception {
                try (DepRoboRIO.RIOShell rshell = DepRoboRIO.discoverAndVerify(org.team1540.chewbawka.Robot.TEAM_NUMBER)) {
